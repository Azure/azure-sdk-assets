...
// CopySourceTags - The blob copy source tags types.
type CopySourceTags string

const (
	// CopySourceTagsCOPY - The blob tags will be copied from the source.
	CopySourceTagsCOPY CopySourceTags = "COPY"
	// CopySourceTagsREPLACE - The blob tags will be replaced.
...
const (
	// GeoReplicationStatusBootstrap - Geo-replication is bootstrap.
	GeoReplicationStatusBootstrap GeoReplicationStatus = "bootstrap"
	// GeoReplicationStatusLive - Geo-replication is live.
	GeoReplicationStatusLive GeoReplicationStatus = "live"
	// GeoReplicationStatusUnavailable - Geo-replication is unavailable.
...
const (
	// TypeAppendBlob - The blob is an append blob.
	TypeAppendBlob Type = "AppendBlob"
	// TypeBlockBlob - The blob is a block blob.
	TypeBlockBlob Type = "BlockBlob"
	// TypePageBlob - The blob is a page blob.
	TypePageBlob Type = "PageBlob"
)
