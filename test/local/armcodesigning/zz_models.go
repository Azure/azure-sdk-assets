...
// Account - Artifact signing account resource.
type Account struct {
...
// AccountPatch - Parameters for creating or updating an artifact signing account.
...
// AccountPatchProperties - Properties of the artifact signing account.
type AccountPatchProperties struct {
	// SKU of the artifact signing account.
	SKU *AccountSKUPatch
}

// AccountProperties - Properties of the artifact signing account.
