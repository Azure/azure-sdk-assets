...
// MaxMonthlyVirtualUserHoursLimitRequest - Max monthly virtual usage hours limit request payload.
type MaxMonthlyVirtualUserHoursLimitRequest struct {
	// The new maxMonthlyVirtualUserHours limit, with -1 indicating that there is no limit.
	Limit *int32
}

// MaxMonthlyVirtualUserHoursResource - Max monthly virtual usage hours resource.
type MaxMonthlyVirtualUserHoursResource struct {
	// The resource-specific properties for this resource.
	Properties *MaxMonthlyVirtualUserHoursResourceProperties
...
// MaxMonthlyVirtualUserHoursResourceProperties - Max monthly virtual usage hours resource limit properties.
type MaxMonthlyVirtualUserHoursResourceProperties struct {
	// READ-ONLY; Current limit value, with -1 indicating that there is no limit.
	Limit *int32

	// READ-ONLY; Resource provisioning state.
	ProvisioningState *ResourceState

	// READ-ONLY; Current usage value.
	Usage *int32
}
