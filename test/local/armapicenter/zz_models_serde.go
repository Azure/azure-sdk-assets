...
func (d DeletedServiceProperties) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC3339](objectMap, "softDeletionDate", d.SoftDeletionDate)
	return json.Marshal(objectMap)
}
...
func (d *DeletedServiceProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "softDeletionDate":
			err = unpopulateTime[datetime.RFC3339](val, "SoftDeletionDate", &d.SoftDeletionDate)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
func (l LinkState) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "lastUpdatedOn", l.LastUpdatedOn)
...
func (l *LinkState) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "lastUpdatedOn":
			err = unpopulateTime[datetime.RFC3339](val, "LastUpdatedOn", &l.LastUpdatedOn)
			delete(rawMsg, key)
		case "message":
