...
// LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceClientGetResponse contains the response from method LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceClient.Get.
type LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceClientGetResponse struct {
	// Max monthly virtual usage hours resource.
	MaxMonthlyVirtualUserHoursResource
}

// LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceClientSetResponse contains the response from method LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceClient.Set.
type LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceClientSetResponse struct {
	// Max monthly virtual usage hours resource.
	MaxMonthlyVirtualUserHoursResource
}
