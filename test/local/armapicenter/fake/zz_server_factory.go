...
type ServerFactory struct {
	...
	// APISourcesServer contains the fakes for client APISourcesClient
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "APISourcesClient":
		initServer(&s.trMu, &s.trAPISourcesServer, func() *APISourcesServerTransport { return NewAPISourcesServerTransport(&s.srv.APISourcesServer) })
