...
type ServerFactory struct {
	...
	// LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceServer contains the fakes for client LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceClient
	LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceServer LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceServer
...
type ServerFactoryTransport struct {
	...
	trLoadTestsMaxMonthlyVirtualUserHoursLimitsResourceServer *LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceServerTransport
...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "LoadTestMappingsClient":
		initServer(&s.trMu, &s.trLoadTestMappingsServer, func() *LoadTestMappingsServerTransport {
	...
	case "LoadTestProfileMappingsClient":
		initServer(&s.trMu, &s.trLoadTestProfileMappingsServer, func() *LoadTestProfileMappingsServerTransport {
	...
	case "LoadTestsClient":
		initServer(&s.trMu, &s.trLoadTestsServer, func() *LoadTestsServerTransport { return NewLoadTestsServerTransport(&s.srv.LoadTestsServer) })
		resp, err = s.trLoadTestsServer.Do(req)
	case "LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceClient":
		initServer(&s.trMu, &s.trLoadTestsMaxMonthlyVirtualUserHoursLimitsResourceServer, func() *LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceServerTransport {
			return NewLoadTestsMaxMonthlyVirtualUserHoursLimitsResourceServerTransport(&s.srv.LoadTestsMaxMonthlyVirtualUserHoursLimitsResourceServer)
		})
		resp, err = s.trLoadTestsMaxMonthlyVirtualUserHoursLimitsResourceServer.Do(req)
