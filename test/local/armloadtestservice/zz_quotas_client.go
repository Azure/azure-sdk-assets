...
func (client *QuotasClient) checkAvailabilityCreateRequest(ctx context.Context, location string, quotaBucketName string, quotaBucketRequest QuotaBucketRequest, _ *QuotasClientCheckAvailabilityOptions) (*policy.Request, error) {
...
func (client *QuotasClient) getCreateRequest(ctx context.Context, location string, quotaBucketName string, _ *QuotasClientGetOptions) (*policy.Request, error) {
